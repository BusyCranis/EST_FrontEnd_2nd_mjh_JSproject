...
- 여러개의 html 페이지 간에 로그인 상태 공유
- 장바구니, 바로구매 클릭시 로그인 확인 모달 띄우기
- footer를 빼먹음
- html 태그를 시멘틱한 태그로 바꾸기
<br>
...
## 5. 메인 기능
상품 리스트 페이지와 상품을 클릭했을때 보여줘야하는 상세 페이지를 하나의 페이지 안에 구현했습니다.
<br>
"setEachItemDetailPage"라는 함수와 "mimicMiniStore"라는 객체를 사용하여
<br>
